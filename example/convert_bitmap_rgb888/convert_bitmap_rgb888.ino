...
void openBmp() {
  ...
  if (fmt > 0) {
    ...
    Serial.println("Original Filie size   : " + String(bmp.getBmpSize()));
...
void saveBmp(BmpImage::BMP_IMAGE_PIX_FMT fmt) {
  ...
  if (fmt > 0) {
    ...
    Serial.println("Saved IFile size   : " + String(bmp.getBmpSize()));
...
void setup() {
  ...
  Serial.println();
  Serial.println("=============================");
  Serial.println("Convert RGB888 to RGB565");
  Serial.println("=============================");
  Serial.println();
  openBmp();
  saveBmp(BmpImage::BMP_IMAGE_RGB565);

  Serial.println();  
  Serial.println("=============================");
  Serial.println("Convert RGB888 to GRAY8");
  Serial.println("=============================");
  Serial.println();
  openBmp();
